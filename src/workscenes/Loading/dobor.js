...
import DoborPanel from './doborPanel';
import { wordsToLearn } from '../../constants';
import { countRoutine, logsRoutine, wordsPRoutine } from '../../store/wordsReducer';
...
const Dobor = ({ words, logs, learnCount, point, countRoutine, logsRoutine, wordsPRoutine, doborFinish }) => {
  ...
  return (
    <DoborPanel word={word} doAnswer={doAnswer} doSkip={doSkip} totalCount={totalCount} />
  );
...
const mapDispatchToProps = { countRoutine, logsRoutine, wordsPRoutine };
