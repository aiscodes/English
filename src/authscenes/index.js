...
import LoginKode from "./LoginPassword/loginKode";
import LoginNew from "./LoginPassword/loginNew";
  ...
  return (
    <NavigationContainer>
      <Stack.Navigator screenOptions={{ headerStyle: { backgroundColor: 'red' } }}>
        ...
        <Stack.Screen name='LoginKode' options={{ header: props => <Header props={props} />, headerTintColor: '#2A80F1' }} component={LoginKode} />
        <Stack.Screen name='LoginNew' options={{ header: props => <Header props={props} />, headerTintColor: '#2A80F1' }} component={LoginNew} />
